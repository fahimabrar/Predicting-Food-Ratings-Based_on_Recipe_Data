...
Here **Polarity** means how much positive or negative meaning the text has. Suppose good is positive word and bad is a negative word. 
Polarity scaled between -1 to +1. -1 means the extremely negative meaningful text. +1 means the most positive text.
